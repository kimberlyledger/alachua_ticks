...
#### plot model residuals for top model
```{r}
...
#### summary of top model *Amblyomma americanum* model 
```{r}
...
#### remove potentially problimatic sites 
...
#### plot the top model for *Amblyomma americanum*  
...
#### summary of top *I. scapularis* model 
pseudo r-squared of model 
```{r}
...
#### remove potentially problematic sites 
...
#### test for spatial autocorrelation in the screened PC1_500m model (nb.glm9.reduced)
...
#### summary of the NEW top *I. scapularis* model 
```{r}
...
#### plot the top model for *I. scapularis* 
