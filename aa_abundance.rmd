...
stargazer(nb.glm12, nb.glm11, type = "text",
          intercept.bottom = FALSE, 
          single.row=FALSE,     
          notes.append = FALSE, 
          header=FALSE)
...
stargazer(nb.glm8, nb.glm9, type = "text",
          intercept.bottom = FALSE, 
          single.row=FALSE,     
          notes.append = FALSE, 
          header=FALSE)
...
doesn't ggsave correct.. try this... 
